...
public class Healthbar extends GameObject {
    ...
    public void render(GameContainer gc, Renderer r) {
        r.drawFillRect((int)Math.floor(barOwner.getPosX()), (int)Math.floor(barOwner.getPosY()-4), barOwner.getWidth()*2, heigth*2, BACKGROUND_COLOR);
        r.drawFillRect((int)Math.floor(barOwner.getPosX()), (int)Math.floor(barOwner.getPosY()-4), (int)hpBar*2, heigth*2, hpColor);
    }
}
